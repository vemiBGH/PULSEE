...
class System_Parameters(FloatLayout):
    ...
    def magnetic_field_parameters(self, x_shift, y_shift):
        ...
        self.mag_field_label = Label(text='Magnetic field', size=(10, 5), pos=(x_shift - 285, y_shift + 100),
                                     font_size='20sp')
        self.add_widget(self.mag_field_label)

        # Field magnitude
        self.field_mag_label = Label(text='Field magnitude', size=(10, 5), pos=(x_shift - 296, y_shift + 50),
                                     font_size='15sp')
    ...
    def quadrupole_parameters(self, x_shift=0, y_shift=0):
        self.quad_int = Label(text='Quadrupole interaction', size=(10, 5), pos=(x_shift - 250, y_shift + 90),
                              font_size='20sp')
        self.add_widget(self.quad_int)

        # Coupling constant
        self.coupling_label = Label(text='Coupling constant e\N{SUPERSCRIPT TWO}qQ', size=(10, 5),
                                    pos=(x_shift - 271, y_shift + 40), font_size='15sp')
        ...
        # Asymmetry parameter
        self.asymmetry_label = Label(text='Asymmetry parameter', size=(10, 5), pos=(x_shift + 25, y_shift + 40),
                                     font_size='15sp')
        ...
        self.alpha_q_label = Label(text='\N{GREEK SMALL LETTER ALPHA}Q', size=(10, 5),
                                   pos=(x_shift - 341, y_shift - 10), font_size='15sp')
        ...
        self.beta_q_label = Label(text='\N{GREEK SMALL LETTER BETA}Q', size=(10, 5), pos=(x_shift - 180, y_shift - 10),
                                  font_size='15sp')
        ...
        self.gamma_q_label = Label(text='\N{GREEK SMALL LETTER GAMMA}Q', size=(10, 5), pos=(x_shift - 19, y_shift - 10),
                                   font_size='15sp')
    ...
    def launch_evolution(self, sim_man, *args):
        try:
            ...
            for i in range(sim_man.n_pulses):
                sim_man.dm[i + 1] = evolve(sim_man.spins, sim_man.h_unperturbed, sim_man.dm[i], 'magnus', \
...
class Panels(TabbedPanel):
    ...
    def __init__(self, sim_man, **kwargs):
        ...
        self.retrieve_config_btn = Button(text='Retrieve configuration', size_hint=(0.23, 0.03), pos=(565, 945),
